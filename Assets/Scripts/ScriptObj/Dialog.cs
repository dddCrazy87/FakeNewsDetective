...
public class Dialog : ScriptableObject {
    public Dictionary<string, List<KeyValuePair<int, string>>> dialogContent = new(){
        { "KP", new List<KeyValuePair<int, string>> {
            ...
            { new KeyValuePair<int, string>(2, "咳，不是啦，我想是這樣啦，") },
            { new KeyValuePair<int, string>(2, "人家很熱心要送你，我拒絕再拒絕，這樣不太好，所以就收下了。") },
            { new KeyValuePair<int, string>(2, "有人說我言行不一致，我想是這樣啦，做人有時候也要懂得謙讓，") },
            { new KeyValuePair<int, string>(2, "總不可能人家一送過來，我就說喔好好好，我剛好肚子餓想吃吧。") },
            { new KeyValuePair<int, string>(2, "咳，所以我想這題是這樣啦，") },
            { new KeyValuePair<int, string>(2, "人家好意我們會收下，\n但是我不是要到處騙吃騙喝，") },
            ...
            { new KeyValuePair<int, string>(2, "咳，所以這題是這樣啦，不管吃什麼，反正拉出來都一樣，所以我基本不挑食，") },
            ...
            { new KeyValuePair<int, string>(2, "咳，好啦，有你這樣的年輕人齁，很好啦。") },
            { new KeyValuePair<int, string>(2, "咳，不要被現在的媒體騙了，要多多查證證據，這樣台灣才會進步啦") },
        ...
        { "VideoProfesser2", new List<KeyValuePair<int, string>> {
            ...
            { new KeyValuePair<int, string>(1, "原來影片是真的嗎？\n那不就代表女王真的不是人類嗎？") },
            { new KeyValuePair<int, string>(1, "不對不對，在這個充斥著假消息的年代，\n現在下定論還太早了") },
        ...
        { "Soldier1", new List<KeyValuePair<int, string>> {
            ...
            { new KeyValuePair<int, string>(2, "要是未經許可從這邊通過，\n只有死路一條！") },
            { new KeyValuePair<int, string>(1, "啊！非常不好意思，我這就離開！！") },
            { new KeyValuePair<int, string>(1, "呼...看來這邊應該是沒辦法讓我進去了") },
            { new KeyValuePair<int, string>(1, "不過我想也是，\n總不會讓我在皇居裡面調查吧") },
            { new KeyValuePair<int, string>(1, "沒辦法了，\n只好回家看能不能蒐集其他線索了") }
        }},
        ...
        { "MainSelf2", new List<KeyValuePair<int, string>> {
            { new KeyValuePair<int, string>(1, "...") },
            { new KeyValuePair<int, string>(1, "真的完全沒有頭緒，\n來看個電視冷靜一下好了") },
            { new KeyValuePair<int, string>(2, "......為您播報下一則新聞") },
            { new KeyValuePair<int, string>(2, "今天就是女王一年一度\n前往七星山的日子了！") },
            { new KeyValuePair<int, string>(1, "咦？") },
            { new KeyValuePair<int, string>(2, "每年的清明節，\n女王都會前往七星山為已逝的祖父掃墓") },
            ...
            { new KeyValuePair<int, string>(1, "如果能夠在女王去掃墓的時候，\n偷偷地跟在他後面，") },
        ...
        { "MainSelf3", new List<KeyValuePair<int, string>> {
            { new KeyValuePair<int, string>(1, "一直跟在女王的後面，總算到達這裡了") },
            { new KeyValuePair<int, string>(1, "剛剛女王就是在這邊掃墓，也就是說...") },
            { new KeyValuePair<int, string>(1, "這就是女王的祖父－Mr.X的墓碑...嗎？") },
            ...
            { new KeyValuePair<int, string>(1, "為了知道Mr.X是不是人類，\n我也只能這樣做了。") }
        }},
        ...
        { "MainSelf5", new List<KeyValuePair<int, string>> {
            ...
            { new KeyValuePair<int, string>(1, "（分析中）") },
            { new KeyValuePair<int, string>(1, "...") },
            { new KeyValuePair<int, string>(1, "......") },
            { new KeyValuePair<int, string>(1, ".........!!!") },
            ...
            { new KeyValuePair<int, string>(1, "這表示，Mr.X不是地球人也不是蜥蜴人，\n而是矽基生命...") },
            { new KeyValuePair<int, string>(1, "也就是外星人啊...") },
            { new KeyValuePair<int, string>(1, "真不得了，沒想到外星生命竟然真的存在") },
            { new KeyValuePair<int, string>(1, "也就是說，具有Mr.X血統的人，包括女王，\n也是一部分的外星人嗎？") },
            { new KeyValuePair<int, string>(1, "看來女王的身分已經水落石出了呢。") },
            { new KeyValuePair<int, string>(1, "...") },
            { new KeyValuePair<int, string>(1, "等等，難道更之前的35代以前的皇室，\n也全部都是外星人嗎") },
            { new KeyValuePair<int, string>(1, "...") },
        ...
        { "MainSelf6", new List<KeyValuePair<int, string>> {
            ...
            { new KeyValuePair<int, string>(1, "好了，就把這個...呃...東西，\n拿回去研究吧") }
        }},
        { "MainSelf7", new List<KeyValuePair<int, string>> {
            ...
            { new KeyValuePair<int, string>(1, "這代表第35代前的皇室並不是外星人，\n而是地球人") },
            { new KeyValuePair<int, string>(1, "原來如此，這樣就證實了這部分是真實新聞\n女王確實是外星人") }
        }},
        ...
        { "News1", new List<KeyValuePair<int, string>> {
            ...
            { new KeyValuePair<int, string>(1, "根據新聞，\n這位總統候選人似乎言行不一、裝模作樣") },
            { new KeyValuePair<int, string>(1, "甚至非常沒有公德心，\n把食物吐在夜市地上") },
